...
import (
	_type "github.com/mbparis/buf-tour/gen/google/type"
...
var file_pet_v1_pet_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x7d, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x2e, 0x70,
	0x65, 0x74, 0x2e, 0x76, 0x31, 0x42, 0x08, 0x50, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
	0x01, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x62,
	0x70, 0x61, 0x72, 0x69, 0x73, 0x2f, 0x62, 0x75, 0x66, 0x2d, 0x74, 0x6f, 0x75, 0x72, 0x2f, 0x67,
	0x65, 0x6e, 0x2f, 0x70, 0x65, 0x74, 0x2f, 0x76, 0x31, 0x3b, 0x70, 0x65, 0x74, 0x76, 0x31, 0xa2,
	0x02, 0x03, 0x50, 0x58, 0x58, 0xaa, 0x02, 0x06, 0x50, 0x65, 0x74, 0x2e, 0x56, 0x31, 0xca, 0x02,
	0x06, 0x50, 0x65, 0x74, 0x5c, 0x56, 0x31, 0xe2, 0x02, 0x12, 0x50, 0x65, 0x74, 0x5c, 0x56, 0x31,
...
func file_pet_v1_pet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pet_v1_pet_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Pet); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pet_v1_pet_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_pet_v1_pet_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_pet_v1_pet_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_pet_v1_pet_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_pet_v1_pet_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_pet_v1_pet_proto_msgTypes[6].Exporter = func(v any, i int) any {
